...
import com.kundy.excelutils.utils.StringUtils;
import com.kundy.excelutils.utils.YamlUtil;
...
public class Global {
    ...
    public static String getName() {
        return StringUtils.nvl(getConfig("project.name"), "System");
    }
    ...
    public static String isDemoEnabled() {
        return StringUtils.nvl(getConfig("project.demoEnabled"), "false");
    }
